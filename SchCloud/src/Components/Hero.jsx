  ...
  return (
    ...
    >
      ...
      <div className=" mx-auto md:mt-40 grid grid-flow-cols cols-1 md:grid-cols-2 gap-6 mt-30">
        <div id="firstContainer" className=" rounded-xl ">
          <h1
            className="
          ...
          <div className="text-1xl flex gap-10 mb-5">
            <div className=" text-blue">
              <button className="bg-white text-blue-600 font-bold py-3 px-6 rounded-2xl transition relative overflow-hidden hover:translate-y-0.5 ">
                Start Free Trial
                <FaArrowRight className="inline-flex size-5 ml-3" />
              </button>
            </div>
            <div className=" bg-transparent text-white font-bold">
              <button className=" border-2  py-3 px-6 rounded-2xl transition relative overflow-hidden hover:-translate-y-0.5 hover:bg-white hover:text-blue-500 hover:border-2">
          ...
          <div id="stat" className="flex flex-row gap-6 items-center mb-5">
